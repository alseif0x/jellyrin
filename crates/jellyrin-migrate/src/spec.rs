...
pub static OMITTED_TABLES: &[OmittedTableSpec] = &[
    ...
    OmittedTableSpec {
        table: "media_item_query_filter_summary_values",
        strategy: "rebuild",
        reason: "derived exact aggregate item-filter values",
    },
    OmittedTableSpec {
        table: "media_item_query_filter_summary_coverage",
        strategy: "rebuild",
    ...
    OmittedTableSpec {
        table: "media_item_upcoming_dates",
        strategy: "rebuild",
