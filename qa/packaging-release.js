...
async function main() {
  ...
  const checks = [
    ...
    check('docker-locked-base-images', dockerfile.includes('RUST_IMAGE=docker.io/library/rust:1.94.0-bookworm@sha256:') && dockerfile.includes('RUNTIME_IMAGE=docker.io/library/debian:bookworm-slim@sha256:')),
    ...
    check('supply-chain-lock-present', supplyChainLock.includes('RUST_IMAGE=docker.io/library/rust:1.94.0-bookworm@sha256:') && supplyChainLock.includes('SYFT_LINUX_AMD64_SHA256=') && supplyChainLock.includes('JELLYFIN_WEB_VERSION=10.11.11') && supplyChainLock.includes('JELLYFIN_WEB_COMMIT=35c0793ece3adbd247eab290ae1effab851f3d37') && supplyChainLock.includes('JELLYFIN_WEB_TARBALL_SHA256=1dd84a8bf4aaa90b12ca38e72e68a554826ab0ea28bb354bcc3212f579e0a337') && supplyChainLock.includes('JELLYFIN_WEB_SWIPER_VERSION=12.1.2') && supplyChainLock.includes('JELLYFIN_WEB_SWIPER_PATCH_COMMIT=3cb38a0ac319edfcbcd331e3818cc9f6dec3e334') && supplyChainLock.includes('JELLYFIN_WEB_SWIPER_PATCH_SHA256=76e80a084337162a24dba022760492fa52f102fbf88747ff895b7076fc17f4b4')),
