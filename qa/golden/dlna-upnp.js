...
function buildEvidence(result, discoveryEvidence, eventsEvidence, manualEvidence) {
  ...
  return {
    ...
    openRisks: deviceValidated ? [] : [
      ...
      `Run npm run golden:dlna:device-preflight -- --base-url http://<server-lan-ip>:8097 to validate descriptor/icon/SCPD/SOAP readiness, then add at least one passing DLNA device evidence JSON under ${deviceEvidence.directory}.`,
