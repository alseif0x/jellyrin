...
async function main() {
  ...
  const evidence = {
    ...
    completedTargets: passed
      ? ['persistent-plugin-model', 'safe-plugin-lifecycle', 'zip-package-extraction', 'package-checksum-policy']
      : [],
    ...
    openRisks: [
      ...
      'Remote repository refresh, update/downgrade and async cancellation still need full P2 coverage.',
