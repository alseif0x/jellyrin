...
async function main() {
  ...
  const evidence = {
    ...
    openRisks: [
      ...
      'RustWasi host executes manifest-declared i32 WASM exports with zero or one i32 argument, an initial SDK-style host import fixture and a memory/data-segment UTF-8 string ABI fixture; full WASI imports and production SDK runtime calls are still pending.',
