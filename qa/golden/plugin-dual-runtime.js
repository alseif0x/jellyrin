...
async function main() {
  ...
  const evidence = {
    ...
    openRisks: [
      'DotNetJellyfin sidecar executes only manifest-declared fixture assemblies through dotnet JSON stdout; real Jellyfin plugin assembly loading and extension-point adapters are still pending.',
      'RustWasi host executes only manifest-declared no-arg i32 WASM exports; full WASI imports, SDK runtime calls and provider/task ABI execution are still pending.',
