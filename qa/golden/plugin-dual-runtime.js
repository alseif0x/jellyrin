...
async function main() {
  ...
  const evidence = {
    ...
    openRisks: [
      ...
      'Package install cancellation is cooperative at checkpoints; immediate interruption of in-flight HTTP downloads and unzip subprocesses still needs streaming/process-level cancellation.',
