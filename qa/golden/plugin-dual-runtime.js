...
async function main() {
  ...
  const evidence = {
    ...
    openRisks: [
      ...
      'RustWasi host executes only manifest-declared i32 WASM exports with zero or one i32 argument; full WASI imports and SDK runtime calls are still pending.',
