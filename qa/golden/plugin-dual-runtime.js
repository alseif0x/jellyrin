...
async function main() {
  ...
  const evidence = {
    ...
    openRisks: [
      'DotNetJellyfin sidecar still does not execute .NET assemblies or real extension points.',
      'RustWasi host still does not execute WASM or expose the SDK/runtime engine.',
      'Package install extracts package artifacts and records a safe NotSupported state when a host is unavailable; real provider/task execution is still pending.',
      'No .NET assembly or WASM fixture has been executed yet.',
    ],
  };
