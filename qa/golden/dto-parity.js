...
function buildContexts(apiParity, browser) {
  ...
  return {
    ...
    itemDetailApi: apiBodyContext(apiByName['item-detail-movie'], 'golden-traces/api-parity-latest.json item-detail-movie body'),
    ...
    playbackInfoTranscodeResponse: apiBodyContext(apiByName['item-playback-info-transcode-movie'], 'golden-traces/api-parity-latest.json item-playback-info-transcode-movie body'),
    playbackInfoErrorResponse: apiBodyContext(apiByName['item-playback-info-invalid-media-source'], 'golden-traces/api-parity-latest.json item-playback-info-invalid-media-source body'),
...
function ruleFor(field) {
  ...
  const exact = {
    ...
    'PlaybackInfoResponse.ErrorCode': ['playbackInfoErrorResponse', ['ErrorCode']],
    ...
    'BaseItemDto.Overview': ['itemDetailApi', ['Overview']],
